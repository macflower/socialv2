<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Gender -->
        <div class="col-span-6 sm:col-span-4">
            <select wire:model.defer="state.gender" class="border-gray-300 dark:border-gray-800 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-800 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
