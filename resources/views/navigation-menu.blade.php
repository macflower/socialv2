        ...
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('profile', Auth::user()) }}" :active="request()->routeIs('profile')">
                        Профиль
                    </x-jet-nav-link>
                </div>
            @endauth
